...
def generate_excel_report(joined_gdf, kml_gdf, min_goal, max_goal, cong_name):
    ...
    with pd.ExcelWriter(output, engine='openpyxl') as writer:
        ...
        # --- TAB 3: ADDRESS LIST ---
        # Extract full precision Latitude and Longitude from the shapefile
        ...
        # Adding HouseSx, Muni, Latitude, and Longitude to the export hidden columns
